...
- 构图必须像贴纸/表情包：芒狗居中且占画面 70%-85%，不要把芒狗缩小放进复杂场景里
- 背景必须简洁、浅色、留白多，可以是纯色、浅黄/浅粉渐变、少量爱心/星星/小点点，只能用 0-2 个小道具或小符号点题，不要强场景化
- 可以让芒狗有不同动作：抱爱心、举小手、趴着、瘫着、抱小签、盖小被子、戴眼镜、伸手、坐着发呆等，但动作要简单可爱，不能改变身体比例
...
export function buildUserPrompt(input: UserPromptInput): string {
  ...
  if (input.primaryReference) {
    ...
    parts.push('图片要像基准图那样是贴纸/表情包式主角大图：芒狗居中、占画面大部分，只允许轻微改变动作和表情来贴合主题。');
    parts.push('背景保持简洁可爱，可以用小爱心、小星星、小点点或一个小道具点题，不能变成复杂房间/办公室/床/完整场景，也不要出现任何文字。');
  } else {
