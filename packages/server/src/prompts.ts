...
- 背景必须简洁、浅色、留白多，只能用 1-3 个小道具或小符号点题，不要强场景化
- 可以让芒狗有不同动作：趴着、瘫着、举小牌、抱好运签、盖小被子、戴眼镜、伸手、坐着发呆等，但动作要简单可爱
- 表情要在基准 IP 基础上轻微变化：困困、低电量、开心、期待、委屈、治愈微笑，不要夸张表情
- 画风要像基准图：包浆感、蜡笔/铅笔笔刷、柔软边线、轻微模糊、儿童手绘感
- 避免复杂文字、复杂背景、真实摄影感、3D、厚涂、强透视、多人同框
...
【输出 JSON 结构】
{
  ...
  "imageScene": "中文图片构图描述，重点写芒狗动作和表情，背景简洁可爱，只用少量道具点题",
  "imagePrompt": "English prompt for GPT Image, locking the Mango dog character identity, simple cute background, focus on pose and expression",
...
export function buildUserPrompt(input: UserPromptInput): string {
  ...
  if (input.primaryReference) {
    ...
    parts.push('只允许轻微改变动作和表情来贴合主题，背景保持简洁可爱，不能变成复杂大场景。');
  } else {
